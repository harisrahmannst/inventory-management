                        ...
                        <tbody>
                            @foreach ($types as $type)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $type->created_at->format('d F Y H:i') }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="{{ route('type.destroy', $type->id) }}" 
                                            ...
                                            onclick="event.preventDefault(); if (confirm('Are you sure you want to delete this Type?')) document.getElementById('delete-form-{{ $type->id }}').submit();">
                                            Delete
                                        </a>
