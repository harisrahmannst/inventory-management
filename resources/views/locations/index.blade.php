<x-app-layout>
    ...
    <div class="py-2">
        <div class="p-4 sm:ml-64">
            ...
            <form action="{{ route('location.create') }}" method="get">
                <button type="submit"
                        ...
                        <tbody>
                            @foreach ($locations as $location)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $location->site->name_site }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $location->created_at->format('d F Y H:i') }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <a href="{{ route('location.destroy', $location->id) }}" 
                                            ...
                                            onclick="event.preventDefault(); if (confirm('Are you sure you want to delete this Location?')) document.getElementById('delete-form-{{ $location->id }}').submit();">
                                            Delete
                                        </a>
